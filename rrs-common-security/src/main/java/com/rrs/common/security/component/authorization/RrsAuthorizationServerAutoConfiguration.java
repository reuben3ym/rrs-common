...
import com.rrs.common.security.component.authorization.listener.AuthenticationSuccessEventListener;
import com.rrs.common.security.component.authorization.controller.TokenController;
import com.rrs.common.security.service.RedisAuthorizationCodeServices;
import com.rrs.common.security.service.RedisClientDetailsService;
import com.rrs.common.security.service.UserDetailsServiceImpl;
 ...
 * @date 2020年6月23日
 */
public class RrsAuthorizationServerAutoConfiguration {

    @Bean
    @ConfigurationProperties(prefix="rrs.security.config")
    public RrsSecurityProperties rrsSecurityProperties(){
        return new RrsSecurityProperties();
    }
