package com.rrs.common.core.config.mybatis.permission;
...
import com.rrs.common.core.config.mybatis.permission.mapper.CommonDataPermissionMapper;
import com.rrs.common.core.util.*;
import com.rrs.common.core.xss.SqlFilter;
import com.rrs.common.core.aspect.annotation.DataPermission;
import com.rrs.common.core.aspect.annotation.DataPermission.DataPermissions;
import com.rrs.common.core.constant.Constants;
import com.rrs.common.core.exception.SysException;
import com.rrs.common.core.permission.SourceStrategy;
import com.rrs.common.core.permission.provider.AbstractDataPermissionProvider;
...
public class PermissionParser implements ISqlParser, InitializingBean {
    ...
    @Value("${rrs.data-permission.table-name:T_SYS_DATA_PERMISSION}")
